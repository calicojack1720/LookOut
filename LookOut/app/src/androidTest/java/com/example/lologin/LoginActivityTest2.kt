...
class LoginActivityTest2 {
    //Registers an account with firebase
    ...
    fun loginActivityTest2() {
        ...
        val appCompatEditText3 = onView(
            allOf(
                withId(R.id.inputPassword), withText("test"),
                childAtPosition(
                    allOf(
                        withId(R.id.container),
                        childAtPosition(
        ...
        appCompatEditText4.perform(replaceText("testit"))

        val appCompatEditText5 = onView(
            allOf(
                withId(R.id.inputPassword), withText("testit"),
                childAtPosition(
                    allOf(
                        withId(R.id.container),
                        childAtPosition(
